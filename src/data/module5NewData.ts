...
export const module5Data: SubtopicData[] = [
  {
    ...
    discover: {
      scenario: 'You are designing a budgeting app for B.Com students. You assume: "Students need complex financial tracking with 20 categories, investment portfolio management, and tax planning features." You spend 3 months building this. Launch day: 5 downloads, 0 active users. You are confused: "I built everything students need for finance!" You interview 10 students. Reality: "We just want to track: Did I overspend this month? Can I afford weekend plans? Simple. Your app is overwhelming - 20 categories? We have 3 expenses: food, transport, fun. Investment portfolio? We have ₹500 in our account, not ₹5 lakhs. Tax planning? We do not even file taxes yet." You built what YOU thought students need, not what they ACTUALLY need. You lacked empathy - deep understanding of their real problems, emotions, and context. Meanwhile, a competing app ("Split It") has 5000 users. Why? They interviewed 50 students, discovered: "We struggle to split bills with roommates (rent, food, utilities). We need: Add expense → Select who paid → Auto-calculate who owes whom → Send payment reminders. That is it." Simple, empathetic, solves a REAL pain point. You need to learn empathy before building your next product.',
      problemExplanation: [
        '🤔 Assume You Know What Others Need: You are a B.Com student, so you assume ALL B.Com students have the same needs as you. You love detailed financial tracking (20 categories), so you assume everyone does. Reality: You are an outlier. Most students want simplicity, not complexity. Assumption without validation = building the wrong product. You wasted 3 months because you did not verify: "Do students actually want this?" Empathy requires setting aside YOUR needs and understanding THEIR needs.',
        '🚫 Skip User Research: You did not talk to a single student before building. Why? "I am a student, I know what students want." This is projection bias - assuming others think like you. Result: You built features nobody asked for (investment portfolio, tax planning) and missed features they desperately need (bill splitting, payment reminders). User research (interviews, surveys, observation) reveals the gap between what you assume and what users actually need. Skipping research = flying blind.',
        '👂 Do Not Listen Deeply: After launch failure, you interview students. But you do not LISTEN. Student: "Your app is too complicated." You hear: "They do not understand finance. I need to add a tutorial." Student actually means: "I do not need 20 categories. I need 3. Simplify." You are listening to respond (defend your design), not listening to understand (learn their real problem). Deep listening requires suspending your ego and truly hearing what users are saying - and NOT saying.',
        '🎭 Project Own Biases: You are passionate about personal finance (you read finance books, track every rupee, optimize investments). You assume students share this passion. Reality: Most students see budgeting as a chore, not a hobby. They want to spend 30 seconds logging expenses, not 10 minutes categorizing and analyzing. Your bias (finance is exciting!) blinds you to their reality (finance is boring, make it quick). Empathy requires recognizing: My perspective ≠ their perspective.',
        '📊 No Observation in Context: You interviewed students in a classroom (formal setting). They gave polite, generic answers: "Yeah, budgeting is important. Investment tracking sounds useful." But you did not OBSERVE them in their natural context (hostel room, cafe, weekend). Observation reveals: They split bills on WhatsApp (messy, error-prone, awkward reminders). They forget to log expenses (too much friction). They check balance once a week, not daily. Context matters. Interviews tell you what people SAY. Observation shows what people DO. Empathy requires both.',
        '💔 Miss the Emotional Pain Point: You focused on functional needs (tracking, categorizing, reporting). You missed the emotional pain: "I feel awkward asking my roommate for the ₹200 he owes me. I feel stressed not knowing if I can afford weekend plans. I feel embarrassed when I overspend and have to borrow money." Empathy is understanding not just WHAT users need (features), but WHY they need it (emotional drivers). "Split It" succeeded because they addressed emotional pain: "Remove awkwardness from bill splitting. Give peace of mind about spending." You focused on features. They focused on feelings.'
      ],
      solutionApproach: [
        '👂 Practice Active Listening: Listen to UNDERSTAND, not to respond. When a student says "Your app is too complicated," do not immediately defend ("But I added a tutorial!"). Instead, ask: "What specifically feels complicated? Can you show me where you got stuck? What would simple look like to you?" Listen for: (1) What they are saying (words), (2) What they are NOT saying (gaps), (3) How they are saying it (tone, emotion). Take notes. Repeat back: "I hear you saying X. Is that right?" This confirms understanding and shows you care.',
        '🎤 Conduct User Interviews: Talk to 20-30 students BEFORE building. Ask open-ended questions: "Tell me about the last time you struggled with money management." "Walk me through how you currently split bills with roommates." "What is the most frustrating part of budgeting?" Avoid leading questions: "Would you use an app that tracks investments?" (leads to "yes"). Instead: "How do you currently manage your finances?" Listen for pain points, workarounds, emotions. Record interviews (with permission). Analyze patterns: What problems recur across 10+ interviews? That is your real opportunity.',
        '🗺️ Create Empathy Maps: After interviews, create empathy maps for your target user (B.Com student, 19-22 years old, living in hostel/PG). Four quadrants: (1) THINK: "I need to save money. I do not understand investments. I feel bad asking for money owed." (2) FEEL: "Stressed about overspending. Awkward about bill splitting. Overwhelmed by complex finance apps." (3) SAY: "Budgeting is important. I should track expenses." (4) DO: "Forget to log expenses. Split bills on WhatsApp. Check balance once a week." Empathy map reveals: What they SAY ("budgeting is important") ≠ what they DO ("forget to log"). Design for behavior, not intentions.',
        '👀 Shadow and Observe Users: Spend a day with 5 students. Observe: (1) How do they currently manage money? (Notebook? Excel? Mental math? Nothing?) (2) When do they think about money? (End of month when broke? Before weekend plans?) (3) What triggers budgeting behavior? (Overspending guilt? Upcoming expense?) (4) What friction stops them? (Too many steps? Forgot? Do not care?) Observation reveals truths interviews miss. Example: Students SAY "I want detailed reports." You OBSERVE: They never open reports, just check "Am I overspending?" Simple dashboard > detailed reports.',
        '🧘 Suspend Judgment: When a student says "I do not budget, I just wing it," do not judge ("That is irresponsible!"). Instead, understand: "Why do they wing it? What makes budgeting feel like a chore? How can I make it effortless?" Suspend YOUR values (budgeting is good!) and understand THEIR reality (budgeting is boring, I have better things to do). Empathy is not agreeing with users. It is understanding them deeply, even when you disagree. This understanding reveals: They do not need a complex budgeting app. They need a simple "Am I overspending?" indicator.',
        '🔄 Iterate Based on Empathy: After understanding users deeply, redesign. New app: "Split It - Bill Splitting Made Simple." Features: (1) Add expense (₹500 groceries), (2) Select who paid (Priya), (3) Select who shares it (Priya, Rahul, Anjali), (4) Auto-calculate (Rahul owes ₹167, Anjali owes ₹167), (5) Send reminder (WhatsApp: "Hey Rahul, you owe ₹167 for groceries"). That is it. No 20 categories. No investment tracking. Just solves ONE real pain point (bill splitting awkwardness) with empathy. Result: 5000 users in 3 months. Empathy = product-market fit.'
      ]
    },
    video: {
...
[End Screen: "Next Video: Ideation - Generate 100 Ideas in 1 Hour"]`,
  ...
  },
  {
    ...
    discover: {
      scenario: 'Your college fest needs to raise ₹2 lakhs but only has ₹50K budget. Your team brainstorms fundraising ideas. First idea: "Let us get sponsorships from local businesses." Everyone agrees. Meeting ends after 10 minutes. You have 1 idea. Fast forward 2 weeks: You approached 20 businesses. Only 2 sponsors (₹30K total). You are ₹1.7 lakhs short. Fest is in 3 weeks. Panic mode. Meanwhile, rival college raised ₹3 lakhs for their fest. How? They had a 2-hour ideation session, generated 87 ideas (crowdfunding, alumni donations, paid workshops, food stalls, merchandise, talent show entry fees, corporate partnerships, online fundraiser, skill-based services, etc.). They selected top 10 ideas, executed 5, raised ₹3 lakhs. You had 1 idea (sponsorships). They had 87 ideas. You are ₹1.7L short. They exceeded their goal. The difference? Ideation. You settled for the first obvious idea. They generated quantity, found quality. You need to learn ideation techniques to unlock creative solutions.',
      problemExplanation: [
        '🎯 Settle for First Idea: Your team brainstormed for 10 minutes, found 1 idea (sponsorships), and stopped. Why? The first idea felt "good enough." But "good enough" is the enemy of "great." You did not explore alternatives. What if sponsorships fail (which they did - only ₹30K)? You have no Plan B. Settling for the first idea is mental laziness. Your brain wants to conserve energy, so it stops searching after finding an acceptable solution. But the BEST ideas often come after the 20th, 50th, or 100th idea. You stopped at idea #1.',
        '😨 Fear of Bad Ideas: During brainstorming, Priya suggested: "What if we sell students\' old textbooks and donate 50% to the fest?" Rahul immediately said: "That is stupid. Students will not donate books." Priya stopped sharing ideas. Result: Your team generated only 1 idea (sponsorships) because criticism killed creativity. Priya had 10+ ideas in her head (crowdfunding, food stalls, workshops) but did not share them (fear of being called "stupid"). Fear of judgment = creativity death. Safe environment = idea explosion.',
        '⚖️ Judging Too Early: Ideation has 2 phases: DIVERGE (generate many ideas without judgment), then CONVERGE (evaluate and select best ideas). Your team skipped divergence and jumped to convergence. Rahul judged Priya\'s idea immediately ("That is stupid"). Result: Divergence stopped after 1 idea. You converged too early. Why is this bad? Early judgment kills wild ideas. Wild ideas spark innovation. Example: "Sell textbooks" (wild) might spark "Rent textbooks" (viable) or "Textbook exchange platform" (scalable). But you killed the wild idea before it could spark anything. Judgment = creativity killer.',
        '🧰 Not Enough Ideation Techniques: Your team used one technique: "What ideas do you have?" (random brainstorming). This generated 1 idea. Rival college used 5 techniques: (1) SCAMPER (Substitute, Combine, Adapt, Modify, Put to use, Eliminate, Reverse), (2) "How Might We" questions, (3) Worst Possible Idea (then flip it), (4) Random Word Association, (5) Role Storming (what would Elon Musk do? What would a 10-year-old do?). Each technique generated 15-20 ideas. Total: 87 ideas. More techniques = more ideas. You relied on one technique (random brainstorming) and got 1 idea. They used 5 techniques and got 87 ideas.',
        '🚫 Not Building on Others\' Ideas: Priya: "Sell textbooks." Rahul: "That is stupid." (Criticism, not building.) Better response: "Yes, AND what if we also rent textbooks? Or create a textbook exchange platform?" (Building on the idea.) Building generates more ideas. Criticism stops ideas. Your team criticized (1 idea). Rival team built on ideas (87 ideas). Example: Idea 1: "Food stalls." Build: "Yes, AND what if we partner with local restaurants?" Build: "Yes, AND what if we do a food festival with 10 vendors?" Build: "Yes, AND what if we charge entry fee (₹50) for food festival?" One idea → 4 ideas through building.',
        '🎨 No Divergent Thinking: Your team thought convergently: "What is the ONE best fundraising idea?" (narrow, linear). Rival team thought divergently: "What are ALL possible ways to raise money?" (broad, exploratory). Divergent thinking generates quantity (87 ideas). Convergent thinking selects quality (top 10 ideas). You need BOTH, but you skipped divergence. Result: You had no quantity to select quality from. You picked the only idea you had (sponsorships), which was not the best idea (it raised only ₹30K). Diverge first, converge later.'
      ],
      solutionApproach: [
        '🎲 Defer Judgment (Diverge First): Set a rule: "For 60 minutes, we generate ideas WITHOUT criticism. No but, no that will not work, no that is stupid. Just ideas." Appoint a facilitator to enforce this rule. If someone criticizes, facilitator says: "Hold that thought. We will evaluate later. Right now, just generate." This creates psychological safety. Priya shares: "Sell textbooks, crowdfunding, alumni donations, food stalls, workshops, merchandise, talent show, corporate partnerships, online fundraiser, skill services." 10 ideas in 5 minutes (vs 1 idea in 10 minutes with criticism). Defer judgment = idea explosion.',
        '📈 Quantity Breeds Quality: Set a target: "Generate 50 ideas in 60 minutes." Why 50? (1) First 10 ideas are obvious (sponsorships, donations, fundraisers). (2) Ideas 11-30 are interesting (food festival, workshops, merchandise). (3) Ideas 31-50 are wild (rent out college spaces, sell exam notes, create a dating app for students, host a hackathon). Wild ideas spark innovation. Example: "Dating app" (wild) sparks "Networking app for B.Com students" (viable) sparks "Mentorship platform connecting students with alumni" (scalable, ₹5L revenue potential). You only reach gold (ideas 31-50) if you push through obvious (ideas 1-10) and interesting (ideas 11-30). Quantity = quality.',
        '🛠️ Use SCAMPER Technique: For each fundraising method, apply SCAMPER. SUBSTITUTE: "Instead of sponsorships from businesses, what if we get sponsorships from alumni?" COMBINE: "What if we combine fest with a job fair (companies pay ₹50K to recruit)?" ADAPT: "What if we adapt Shark Tank format (students pitch business ideas, winners get prize money from sponsors)?" MODIFY: "What if we modify food stalls to food FESTIVAL (charge entry fee ₹50, 10 vendors, 2000 students = ₹1L)?" PUT TO USE: "What if we use our college auditorium for paid workshops (Excel, public speaking, ₹200/person)?" ELIMINATE: "What if we eliminate expensive performer (₹2L) and use student talent?" REVERSE: "What if instead of us paying for fest, we make it profitable (charge entry, sell merchandise, sponsors pay for booths)?" SCAMPER generates 7 ideas per fundraising method. 5 methods × 7 SCAMPER prompts = 35 ideas.',
        '🤝 Build on Others\' Ideas ("Yes, AND"): When someone shares an idea, build on it instead of criticizing. Priya: "Food stalls." Rahul: "Yes, AND what if we partner with 10 local restaurants?" Anjali: "Yes, AND what if we do a food festival with ₹50 entry fee?" Karan: "Yes, AND what if we sell fest merchandise (T-shirts, mugs) at the food festival?" One idea (food stalls) → 4 ideas (food festival, entry fee, merchandise) through "Yes, AND." This technique multiplies ideas. Your team used "Yes, BUT" (criticism). Rival team used "Yes, AND" (building). Result: 1 idea vs 87 ideas.',
        '🌊 Divergent Then Convergent Thinking: Phase 1 (Diverge - 60 minutes): Generate 50+ ideas without judgment. Use techniques: Random brainstorming, SCAMPER, "How Might We," Worst Possible Idea (then flip it), Role Storming. Goal: Quantity. Phase 2 (Converge - 30 minutes): Evaluate 50 ideas. Criteria: Feasibility (can we execute in 3 weeks?), Impact (how much money can this raise?), Effort (how much work?). Plot on 2×2 matrix (Impact vs Effort). Select top 10 high-impact, low-effort ideas. Phase 3 (Execute - 3 weeks): Execute top 5 ideas. This process (diverge → converge → execute) generated ₹3 lakhs for rival college. You skipped divergence, jumped to execution with 1 idea, raised ₹30K.',
        '🎭 Role Storming (Think Like Others): Stuck on ideas? Pretend you are someone else. "How would Elon Musk raise ₹2 lakhs for a college fest?" (Answer: Sell tickets to space? Crowdfund with viral campaign? Partner with Tesla for EV showcase?). "How would a 10-year-old raise money?" (Answer: Lemonade stand? Sell handmade crafts? Bake sale?). "How would a B.Com professor raise money?" (Answer: Paid workshops on Excel, GST, financial modeling?). Role storming unlocks new perspectives. You think like yourself (limited). Role storming thinks like 10 different people (unlimited). Result: 10× more ideas.'
      ]
    },
    video: {
...
[End Screen: "Next Video: Prototyping - Test Ideas in 1 Day, Not 3 Months"]`,
  ...
  },
  {
    ...
    context: 'professional' as const,
    discover: {
      scenario: 'You have an idea: Build a study planner app for B.Com students. You spend 4 months coding: User login, calendar integration, task management, reminders, analytics dashboard, social features, gamification, AI recommendations. You invest ₹2 lakhs (developer time, design, hosting). Launch day: You show it to 10 students. Their reaction: "This is too complicated. I just want to write down: What do I need to study today? That is it. Your app has 15 features. I am overwhelmed." You are devastated. 4 months wasted. ₹2 lakhs wasted. Zero users. Meanwhile, your classmate Priya had the same idea. She spent 1 DAY creating a paper prototype (hand-drawn screens on paper). She tested with 10 students. Their feedback: "We do not need calendar integration or AI. Just a simple to-do list: Today I need to study Chapter 3 Accounting, Chapter 5 Economics. Check them off when done. That is all." Priya refined her prototype (2 hours), tested again (5 students loved it), THEN coded a simple app (2 weeks, ₹20K investment). Launch: 500 users in 1 month. You spent 4 months building the wrong thing. Priya spent 1 day prototyping the RIGHT thing. The difference? Prototyping. Test ideas BEFORE building. Fail fast and cheap (1 day, ₹0), not slow and expensive (4 months, ₹2 lakhs).',
      problemExplanation: [
        '🏗️ Build Complete Solutions Before Testing: You coded for 4 months BEFORE showing it to users. Why? You wanted it to be "perfect" before testing. But perfection is expensive (4 months, ₹2 lakhs). And you built the WRONG thing (too complicated, 15 features nobody wanted). If you had tested a paper prototype on Day 1 (₹0 investment), you would have learned: "Students want simple to-do list, not complex app." You could have pivoted immediately (saved 4 months, ₹2 lakhs). Building before testing = expensive mistakes.',
        '😰 Fear of Imperfect Prototypes: You thought: "I cannot show users a paper sketch. It looks unprofessional. They will not take me seriously." So you waited until the app was "polished" (4 months). Reality: Users do not care about polish during testing. They care about: Does this solve my problem? Paper prototype is ENOUGH to test this. Priya showed hand-drawn screens. Students said: "This is exactly what I need!" Your fear of imperfection delayed testing by 4 months. Result: You built the wrong thing beautifully. Priya built the right thing simply.',
        '🚫 Not Testing with Users: You tested your app with yourself (you loved it - 15 features!). You tested with your developer friend (he loved it - great code!). You did NOT test with actual users (B.Com students) until launch day. Result: You built for YOU (feature-rich, complex), not for THEM (simple, focused). Testing with yourself = confirmation bias (you will love what you built). Testing with users = reality check (they tell you what they actually need). You skipped reality check for 4 months.',
        '💸 Waste Time and Resources: 4 months of your time (opportunity cost: you could have built 4 different apps, or studied for exams, or earned money). ₹2 lakhs investment (developer, designer, hosting). Emotional cost (devastation when nobody uses your app). All wasted because you did not prototype and test BEFORE building. Priya invested 1 day (paper prototype) + 2 weeks (simple app) = 2.5 weeks total. You invested 4 months. She succeeded (500 users). You failed (0 users). Prototyping saves time, money, and heartbreak.',
        '🎨 Perfectionism Paralysis: You kept adding features: "What if we add AI recommendations? Social features? Analytics dashboard?" You thought: "More features = better app." Reality: More features = more complexity = users overwhelmed. Students wanted 1 feature (simple to-do list). You built 15 features. Perfectionism (making it feature-rich) prevented you from testing early (when it was simple). If you had tested a basic prototype (just to-do list) on Day 1, you would have learned: "This is enough. Ship it." Instead, you kept building for 4 months, adding features nobody wanted.',
        '📉 No Iteration Based on Feedback: You built Version 1.0 (complete app with 15 features) and launched. No Version 0.1 (paper prototype), no Version 0.2 (clickable wireframe), no Version 0.3 (basic working app). You went from 0 to 100 without testing intermediate versions. Priya iterated: Version 0.1 (paper prototype, tested with 10 students), Version 0.2 (refined paper prototype based on feedback, tested with 5 students), Version 0.3 (coded simple app, tested with 20 students), Version 1.0 (launched). Each iteration incorporated feedback. Result: Version 1.0 was exactly what users wanted. Your Version 1.0 was what YOU wanted, not what users wanted.'
      ],
      solutionApproach: [
        '📝 Start with Paper Prototypes (Day 1, 2 hours): Before coding ANYTHING, draw your app on paper. Hand-draw 5 screens: (1) Home screen (What does user see first?), (2) Add task screen (How do they add a study task?), (3) Task list screen (How do they view tasks?), (4) Check-off screen (How do they mark tasks complete?), (5) Progress screen (How do they see what they accomplished?). Use pen and paper. No design skills needed. Just boxes, text, arrows. This is a low-fidelity prototype. Cost: ₹0. Time: 2 hours. Purpose: Test the CONCEPT (do students want this?), not the execution (is the code good?).',
        '👥 Test with 5 Users Immediately (Day 1, 2 hours): Show your paper prototype to 5 B.Com students. Say: "I am designing a study planner app. Here are hand-drawn screens. Walk me through: How would you use this? What is confusing? What is missing?" Watch them interact with paper screens. Listen to feedback: "I do not need calendar integration. Just a list of what to study today." "Progress screen is nice but not essential." "Can you add: Estimate time for each task?" Document feedback. Cost: ₹0. Time: 2 hours. Learning: Students want simple to-do list (not complex planner), time estimates (new feature you did not think of). You learned this in 4 hours (paper prototype + testing), not 4 months (full app).',
        '🔄 Iterate Rapidly (Days 2-3, 4 hours): Based on feedback, create Version 0.2 (refined paper prototype). Changes: (1) Remove calendar integration (not needed), (2) Remove analytics dashboard (not essential), (3) Add time estimates for each task (new feature from feedback), (4) Simplify to 3 screens (add task, view list, check off). Test with 5 NEW students. Feedback: "Much better! This is simple. I would use this." Validation: Your concept works. Now you can code with confidence. Total investment so far: 8 hours, ₹0. Learning: You validated the concept before investing 4 months and ₹2 lakhs.',
        '💻 Build Low-Fidelity Digital Prototype (Week 2, 3 days): Now that paper prototype is validated, create a clickable wireframe using Figma (free tool). No design, no colors, just boxes and text. Make it clickable: Click "Add task" → Goes to "Add task screen." Click "Check off" → Task is marked complete. Test with 10 students. They click through the prototype. Feedback: "Flow is good. But can you add: Group tasks by subject (Accounting, Economics, Business Law)?" Refine prototype (2 hours), test again. Cost: ₹0 (Figma is free). Time: 3 days. Learning: Flow is validated. New feature request (group by subject). You are refining BEFORE coding.',
        '🚀 Build Minimum Viable Product (Week 3-4, 2 weeks): Now that concept and flow are validated, code a SIMPLE app. Features: (1) Add task (subject, chapter, time estimate), (2) View tasks grouped by subject, (3) Check off when done, (4) See progress (5/10 tasks done today). That is it. No AI, no social features, no analytics. Just the core validated features. Launch to 50 beta users (your classmates). Feedback: "Perfect! This is exactly what I need. Simple and fast." Cost: ₹20K (2 weeks of development). Time: 2 weeks. Result: 50 users love it. You validated before building. Total time: 1 day (paper) + 3 days (wireframe) + 2 weeks (MVP) = 18 days (vs 4 months). Total cost: ₹20K (vs ₹2 lakhs). Success rate: 50 users (vs 0 users).',
        '📊 Fail Fast and Cheap: If your paper prototype had failed (students said "We do not need a study planner at all"), you would have learned this in Day 1 (4 hours, ₹0 investment). You could pivot immediately (build something else). Instead of failing slow and expensive (4 months, ₹2 lakhs, 0 users), you fail fast and cheap (1 day, ₹0, pivot to new idea). Prototyping is risk management. Test assumptions with cheap prototypes BEFORE expensive development. Fail fast = learn fast = succeed fast.'
      ]
    },
    video: {
...
[End Screen: "Next Video: Testing - Validate Assumptions with Real Users"]`,
  ...
  },
  {
    ...
    context: 'professional' as const,
    discover: {
      scenario: 'You built a "B.Com Job Prep Platform" based on YOUR assumptions: "Students need resume templates, interview questions, and company research." You invested 2 months, ₹1 lakh. Launch: 20 downloads, 2 active users. You are confused. You ask the 2 users: "Why are you not using the platform?" They say: "We do not need templates. We need: Someone to REVIEW our resume and tell us what is wrong. We do not need interview questions. We need: MOCK interviews with feedback. We do not need company research. We need: Referrals and introductions to employees." You built based on assumptions (templates, questions, research). Reality: Students need personalized services (reviews, mock interviews, referrals). You wasted 2 months and ₹1L building features nobody wants. Meanwhile, your competitor "PrepBuddy" has 2000 users. Why? They TESTED their assumptions before building. Hypothesis: "Students need resume templates." Test: Offered templates to 20 students. Only 3 used them. Insight: Templates are not the need. Interviewed those 3: "Why did you use templates?" Answer: "I used it, but I do not know if my resume is good. I need someone to review it." Revised hypothesis: "Students need resume REVIEWS, not templates." Test: Offered free resume reviews to 20 students. 18 signed up. Validation: Resume reviews are the real need. They built resume review service (not template library). Result: 2000 users. You assumed. They tested. You failed. They succeeded. You need to learn testing - validate assumptions with real users BEFORE building.',
      problemExplanation: [
        '🤔 Assume Instead of Test: You assumed: "Students need resume templates." Why? Because YOU needed templates when you were job hunting. But your experience ≠ everyone else is experience. You did not TEST this assumption (offer templates to 20 students, see how many use them). You just built based on assumption. Result: You built templates (2 weeks, ₹20K). Reality: Only 3/20 students used them (15% adoption). If you had tested FIRST (1 day, ₹0), you would have learned: "Templates are not the need. Reviews are." You could have pivoted immediately. Testing prevents expensive assumptions.',
        '🚫 No User Validation: You built the entire platform (resume templates, interview questions, company research) without validating with a SINGLE user. You tested with yourself ("I love this!") and your developer friend ("Great features!"). You did NOT test with B.Com students (your target users) until launch day. Result: You built for YOU (feature-rich, comprehensive), not for THEM (personalized, actionable). Validation means: Show prototype to 20 target users, ask "Would you use this? Why or why not?" Learn BEFORE building. You skipped validation for 2 months.',
        '✅ Confirmation Bias: After launch failure, you interviewed 2 active users (the only ones using your platform). You asked: "What do you like about the platform?" They said: "Templates are okay." You concluded: "Templates are good. I just need better marketing." This is confirmation bias - seeking evidence that confirms your belief (templates are good) and ignoring evidence that contradicts it (18/20 students do not use templates). You should have interviewed the 18 who did NOT use it: "Why not?" They would have said: "We need reviews, not templates." Confirmation bias = building wrong thing confidently.',
        '😰 Fear of Negative Feedback: You avoided testing because you feared users would say: "This is not useful." You thought: "If I do not test, I can keep believing my idea is good." So you built for 2 months without testing. Launch day: Reality hit. Users said: "This is not useful." You could have heard this on Day 1 (testing paper prototype, ₹0 cost, pivot immediately). Instead, you heard it on Day 60 (after building, ₹1L cost, too late to pivot). Fear of negative feedback = expensive mistakes. Negative feedback on Day 1 = gift (saves you from wasting 2 months). Negative feedback on Day 60 = disaster (already wasted 2 months).',
        '📊 No Behavioral Observation: You asked users: "Would you use resume templates?" They said: "Yes, sounds useful." (Polite answer.) You assumed: "Great! Build templates." But you did not OBSERVE behavior. If you had said: "Here are 5 templates. Use them to create your resume. I will watch." You would have observed: They download 1 template, stare at it for 5 minutes, get confused ("How do I customize this for MY experience?"), give up, Google "resume review services." Observation reveals: They do not know HOW to use templates. They need guidance (reviews), not tools (templates). What people SAY ≠ what they DO. Test behavior, not intentions.',
        '🎯 No Clear Testing Hypothesis: You tested vaguely: "Let me see if students like my platform." This is not a hypothesis. A hypothesis is: "Students will use resume templates to create resumes (not hire resume writers)." Test: Offer templates to 20 students. Measure: How many create resumes using templates? Result: 3/20 (15%). Hypothesis INVALIDATED. Pivot. Without clear hypothesis, you cannot measure success/failure. You just get vague feedback ("It is okay"). With hypothesis, you get clear data (15% adoption = hypothesis failed, pivot needed). Testing without hypothesis = wasted testing.'
      ],
      solutionApproach: [
        '🧪 Create Clear Testing Hypotheses: Before testing, write down what you are testing. HYPOTHESIS 1: "B.Com students will use resume templates (not hire resume writers) to create job-ready resumes." HYPOTHESIS 2: "Students will spend 30+ minutes using interview questions to prepare for interviews." HYPOTHESIS 3: "Students will read company research before applying to jobs." These are testable statements. Now you can measure: Did they use templates? (Yes/No.) How long did they spend? (30 mins? 5 mins?). Did they read research? (Yes/No.). Clear hypothesis = clear test = clear learning.',
        '👥 Test with 20 Real Users: Show your prototype (paper or wireframe) to 20 B.Com students (your target users). Not yourself. Not your friends. Not developers. REAL target users. Say: "I am testing an idea. Here is a prototype. Try to use it. I will watch and take notes. Be honest - I want to learn, not hear compliments." Watch: (1) Can they complete tasks? (Create resume using template? Practice interview questions?) (2) Where do they get stuck? (Confused by template? Overwhelmed by questions?) (3) Do they achieve their goal? (Job-ready resume? Interview confidence?) (4) What do they say? ("This is helpful" or "This is confusing"). Document everything.',
        '👀 Observe Behavior, Not Just Words: Users say one thing, do another. EXAMPLE: You ask: "Would you use resume templates?" User: "Yes, sounds useful." (Polite answer.) You observe: User downloads template, stares at it, gets confused, closes it. (Actual behavior.) Insight: They SAY they want templates, but they DO NOT know how to use them. They need guidance (resume reviews), not tools (templates). Always observe: What do they DO (behavior) > What do they SAY (intentions). In testing, watch their screen, watch their face (confusion? frustration?), watch their actions (click, scroll, give up?). Behavior reveals truth.',
        '📊 Gather Quantitative Data: Measure everything. (1) Adoption: 3/20 students used templates (15% adoption rate). (2) Time spent: Average 5 minutes (not 30 minutes as you hoped). (3) Completion: 1/3 completed resume using template (33% completion rate). (4) Satisfaction: "Rate 1-10: How useful was this?" Average: 4/10. These numbers tell a story: Low adoption (15%), low time (5 mins), low completion (33%), low satisfaction (4/10) = Hypothesis INVALIDATED. Templates are not the solution. Pivot. Quantitative data removes emotion. You cannot argue with 15% adoption.',
        '💬 Gather Qualitative Data: Numbers tell you WHAT happened (15% adoption). Interviews tell you WHY (why did 85% not use templates?). Ask the 17 who did not use templates: "Why not?" Answers: "I do not know how to customize templates for my experience." "I do not know if my resume is good after using template." "I need someone to review my resume and tell me what to improve." Insight: They need REVIEWS (personalized feedback), not TEMPLATES (generic tools). Qualitative data (interviews) reveals the "why" behind quantitative data (15% adoption). Combine both for complete understanding.',
        '🎁 Welcome Negative Feedback: When users say "This is not useful," do not get defensive ("But I worked 2 months on this!"). Say: "Thank you! This saves me from wasting more time. Tell me: What WOULD be useful?" Negative feedback on Day 1 (testing paper prototype) = gift (saves 2 months, ₹1L). Negative feedback on Day 60 (after building) = disaster (already wasted 2 months, ₹1L). Embrace negative feedback early. It is free consulting. Users tell you: "Do not build this. Build THAT instead." Listen. Pivot. Succeed.'
      ]
    },
    video: {
...
[End Screen: "Next Video: Iteration - Improve Through Continuous Learning"]`,
  ...
  },
  {
    ...
    context: 'professional' as const,
    discover: {
      scenario: 'You launched a study planner app. Version 1.0: 4 features, 50 users, 6/10 satisfaction. You think: "I failed. Only 6/10. I should have made it perfect before launching." You feel defeated and want to give up. Meanwhile, your competitor launched their app. Version 1.0: 3 features, 30 users, 5/10 satisfaction (worse than yours!). But they did not give up. They iterated. Version 1.1 (added time estimates based on feedback): 80 users, 7/10 satisfaction. Version 1.2 (added subject grouping): 200 users, 8/10 satisfaction. Version 1.3 (added priority levels): 500 users, 8.5/10 satisfaction. Version 1.4 (added collaboration features): 1000 users, 9/10 satisfaction. They went from 5/10 (worse than you) to 9/10 (better than you) through 4 iterations in 3 months. You stayed at Version 1.0 (6/10, 50 users) because you thought iteration = failure. Reality: Iteration = progress. They improved 5/10 → 9/10. You stayed at 6/10. The difference? Iterative mindset. They embraced "good enough to test, then improve" (shipped V1.0 at 5/10, iterated to 9/10). You demanded "perfect before shipping" (waited for 6/10, never improved). You need to learn iteration - continuous improvement through Build-Measure-Learn cycles.',
      problemExplanation: [
        '🎯 Perfectionism on First Try: You wanted Version 1.0 to be perfect (10/10 satisfaction). So you spent 4 months building, adding features, polishing. Launch: 6/10 satisfaction. You are disappointed: "I spent 4 months and only got 6/10?" Reality: Version 1.0 is NEVER perfect. It is your first attempt based on assumptions. Users will reveal what is missing (time estimates, subject grouping, priority levels). You cannot predict this. You learn this through iteration. Perfectionism delays learning. You spent 4 months trying to be perfect. Competitor spent 1 month shipping V1.0 (imperfect), then 3 months iterating (learning from users). They learned 4× faster.',
        '😰 Fear of Iteration as Failure: You think: "If I need to iterate, it means I failed the first time." This mindset paralyzes you. You stay at V1.0 (6/10) because releasing V1.1 feels like admitting "V1.0 was not good enough." Reality: Iteration is NOT failure. It is PROGRESS. V1.0 (6/10) → V1.1 (7/10) → V1.2 (8/10) → V1.3 (9/10). Each iteration improves. Competitor embraced this. They released V1.0 (5/10), openly said "This is our first attempt. We will improve based on your feedback." Users appreciated honesty. They iterated to 9/10. You feared iteration, stayed at 6/10. Fear of iteration = fear of improvement.',
        '📚 Not Building on Learnings: After launching V1.0 (6/10 satisfaction), you gathered feedback: "We want time estimates for tasks." "We want to group tasks by subject." "We want priority levels." You documented this feedback, then... did nothing. You did not build V1.1 incorporating these learnings. Why? You thought: "I already launched. I cannot change it now." Reality: You MUST change it. Feedback is free product roadmap. Users told you exactly what to build (time estimates, grouping, priority). Build it! Competitor built V1.1, V1.2, V1.3 based on feedback. You ignored feedback. They improved 5/10 → 9/10. You stayed at 6/10. Not building on learnings = wasted feedback.',
        '➡️ Linear Instead of Cyclical Thinking: You think linearly: Research → Design → Build → Launch → Done. Competitor thinks cyclically: Build V1.0 → Measure (6/10 satisfaction, users want time estimates) → Learn (time estimates are critical) → Build V1.1 (add time estimates) → Measure (7/10 satisfaction, users want grouping) → Learn → Build V1.2 → Repeat. Linear thinking stops after launch. Cyclical thinking continues forever. Result: Linear = V1.0 (6/10, 50 users, stagnant). Cyclical = V1.0 → V1.4 (9/10, 1000 users, growing). Design thinking is a CYCLE (Build-Measure-Learn-Repeat), not a LINE (start to finish).',
        '⏸️ Waiting for Perfect: You have feedback (users want time estimates). You think: "I will add time estimates in Version 2.0 along with 10 other features. Big release in 6 months." You wait 6 months. Competitor thinks: "Users want time estimates. I will add JUST time estimates in V1.1. Release next week." They ship weekly. You ship every 6 months. Result: They iterate 24 times/year (weekly releases). You iterate 2 times/year (6-month releases). They learn 12× faster. They improve 12× faster. They grow 12× faster. Waiting for perfect = slow death. Shipping imperfect = fast growth.',
        '📉 No Measurement Between Iterations: You launched V1.0 (6/10 satisfaction). You plan V2.0 (add 10 features). But you do not measure: Which of the 10 features will improve satisfaction most? You guess. You build all 10 (3 months). Launch V2.0: 6.5/10 satisfaction (only 0.5 improvement!). Why? 8/10 features were not important. 2/10 features (time estimates, grouping) were critical. You wasted 3 months on 8 unimportant features. Competitor measured between iterations: V1.0 → Test → Learn (time estimates = 8/10 importance) → V1.1 (add ONLY time estimates) → Measure (7/10 satisfaction, +1 point improvement). They focused on high-impact features. You scattered effort on low-impact features. Measurement guides iteration.'
      ],
      solutionApproach: [
        '🔄 Embrace Iterative Mindset: Version 1.0 is NOT the final product. It is the FIRST iteration. Expect: V1.0 (6/10) → V1.1 (7/10) → V1.2 (8/10) → V1.3 (9/10). Each iteration improves based on user feedback. This is normal, not failure. Tell users: "This is V1.0. We will improve based on your feedback. Tell us what is missing." Users appreciate honesty and transparency. They become co-creators. Iterative mindset = continuous improvement mindset. You are never "done." You are always improving.',
        '📊 Build-Measure-Learn Cycle: After each iteration, follow this cycle. BUILD: Launch V1.0 (4 features, 1 month). MEASURE: Track metrics (50 users, 6/10 satisfaction, 40% retention). Gather feedback ("We want time estimates"). LEARN: Time estimates are critical (8/10 users requested it). Prioritize this for V1.1. BUILD: Add time estimates (1 week). MEASURE: 80 users, 7/10 satisfaction, 60% retention (+1 point, +20% retention). LEARN: Time estimates worked! Next priority: Subject grouping (6/10 users requested). Repeat. Each cycle takes 1-2 weeks. 24 cycles/year = 24 improvements/year. Competitor does this. You do not. They improve 24×/year. You improve 2×/year. They win.',
        '🎯 Ship "Good Enough to Learn": Do not wait for perfect (10/10). Ship "good enough to learn from users" (6/10). Why? (1) You learn faster (ship V1.0 in 1 month, get feedback, iterate). (2) You improve faster (V1.0 → V1.4 in 3 months through iteration). (3) Users guide you (they tell you what to build next). Perfectionism delays learning. You wait 6 months for 8/10. Competitor ships 6/10 in 1 month, iterates to 9/10 in 3 months. They reach 9/10 before you reach 8/10. Good enough + fast iteration > perfect + slow shipping.',
        '📈 Improve Incrementally: Do not try to jump from 6/10 to 10/10 in one iteration (V2.0 with 10 features). Improve incrementally: 6/10 → 7/10 → 8/10 → 9/10. Each iteration adds 1-2 features (not 10). Why? (1) Faster (1 week per iteration, not 3 months). (2) Focused (improve one thing at a time). (3) Measurable (did time estimates improve satisfaction? Yes, 6/10 → 7/10). (4) Lower risk (if feature fails, you wasted 1 week, not 3 months). Incremental improvement = sustainable growth. Big-bang releases = risky and slow.',
        '🧪 Learn from Each Cycle: After each iteration, document learnings. V1.0 → V1.1: "Added time estimates. Satisfaction improved 6/10 → 7/10. Retention improved 40% → 60%. Learning: Time estimates are high-impact feature. Users want to know: How long will this task take?" V1.1 → V1.2: "Added subject grouping. Satisfaction improved 7/10 → 8/10. Learning: Grouping reduces cognitive load. Users want organized task lists." Document: What worked? What did not? Why? Over 10 iterations, you will see patterns: "Users always want simplicity over features. I should prioritize reducing complexity." Learnings compound. Each iteration makes you smarter.',
        '🚀 Progress Over Perfection: Measure progress, not perfection. V1.0 (6/10) is not perfect, but it is PROGRESS (you shipped!). V1.1 (7/10) is not perfect, but it is PROGRESS (+1 point). V1.2 (8/10) is PROGRESS (+1 point). Celebrate progress: "We improved from 6/10 to 8/10 in 2 months through iteration!" Do not mourn imperfection: "We are only at 8/10, not 10/10." Perfection is a myth. Progress is real. Competitor celebrates progress (5/10 → 9/10 in 3 months). You mourn imperfection (only 6/10). They grow. You stagnate. Progress mindset = growth mindset.'
      ]
    },
    video: {
...
[End Screen: "Next Video: User-Centered Design - Put Users First"]`,
  ...
  },
  {
    ...
    context: 'professional' as const,
    discover: {
      scenario: 'You built an "AI-Powered Financial Planning App" for B.Com students. Features: Investment portfolio optimization, tax planning, retirement calculator, crypto tracking, stock market analysis. You are proud: "This uses cutting-edge AI! Machine learning algorithms! Real-time data!" Launch: 10 downloads, 1 active user. You are confused: "I built the most advanced financial app! Why is nobody using it?" You interview 20 students. Reality check: "I have ₹500 in my account, not ₹5 lakhs. I do not invest in stocks or crypto. I do not file taxes yet. I do not think about retirement (I am 20 years old!). Your app is for wealthy professionals, not broke students. I just want to know: Can I afford weekend plans? That is it." You built a technically ADVANCED app (AI, ML, real-time data) but it is not USER-CENTERED (does not solve student problems). You designed for YOURSELF (you love finance, AI, investing) and TECHNOLOGY (show off ML skills), not for USERS (broke students who want simple budgeting). Meanwhile, "SplitWise" (simple bill-splitting app, no AI, basic tech) has 5 million users. Why? User-centered design. They asked: "What do students actually need?" Answer: "Split bills easily." They built for USERS, not for tech showcase. You built for tech. They built for users. You failed. They succeeded. You need to learn user-centered design - put users at the center of EVERY decision.',
      problemExplanation: [
        '🤖 Technology-First, Not User-First: You started with technology: "I want to use AI and ML." Then you found a problem to apply it to: "Financial planning for students." This is backwards. User-centered design starts with USERS: "What problems do students have?" Answer: "Splitting bills, tracking if they overspent." Then you find technology to solve it: "Simple calculator, no AI needed." You let technology drive design (AI → financial planning). They let users drive design (student problems → bill splitting). Result: Your app is impressive (AI!) but useless (solves problems students do not have). Their app is simple (no AI) but useful (solves real problem). Useful > impressive.',
        '👤 Design for Yourself, Not Users: You love finance (you read finance books, track investments, optimize taxes). You assumed students share this passion. You designed features YOU want (portfolio optimization, tax planning, retirement calculator). Reality: Students do not care about these (they have ₹500, not ₹5 lakhs). They want: "Can I afford weekend plans?" You designed for YOUR interests, not THEIR needs. User-centered design requires: Set aside YOUR preferences, understand THEIR reality, design for THEM. You did the opposite.',
        '🚫 Skip User Involvement: You built for 3 months without talking to a SINGLE student. You did not interview them ("What financial problems do you have?"). You did not show them prototypes ("Would this help you?"). You did not test with them ("Try using this"). You built in isolation, then launched. Result: You built the wrong product. If you had interviewed 10 students in Week 1, they would have told you: "We do not need investment tracking. We need bill splitting." You could have pivoted immediately (saved 3 months). Skipping user involvement = expensive mistakes.',
        '🙉 Ignore User Feedback: After launch (10 downloads, 1 user), you got feedback: "This is too complex. I just want simple budgeting." You thought: "They do not understand the power of AI. I need to educate them." You added tutorials explaining AI. Result: Still 1 user. Why? You IGNORED feedback (they want simple, not complex) and tried to CHANGE users (educate them about AI). User-centered design means: Listen to feedback, change YOUR product (make it simple), not change USERS (educate them to like complexity). You cannot force users to want what you built. You must build what users want.',
        '🎯 Feature-Driven, Not Outcome-Driven: You focused on FEATURES (AI algorithms, real-time data, 15 analysis tools). You did not focus on OUTCOMES (what do users want to achieve?). User outcome: "I want to know if I can afford weekend plans without going broke." Your features: Portfolio optimization, tax planning, retirement calculator. Mismatch! Features do not deliver the outcome users want. User-centered design starts with outcomes: "What do users want to achieve?" Then builds features that deliver those outcomes. You started with features (AI, ML), then hoped users would find them useful. They did not.',
        '💰 Measure Tech Metrics, Not User Satisfaction: You measured: "AI accuracy: 95%! Real-time data latency: 50ms! Algorithm efficiency: O(log n)!" You were proud of technical performance. But you did not measure: User satisfaction (1/10 users find it useful). Task completion (can users achieve their goal?). Time to value (how long to get value? 30 mins to set up portfolio = too long). User-centered design measures USER metrics (satisfaction, task completion, time to value), not TECH metrics (accuracy, latency, efficiency). Tech metrics matter to developers. User metrics matter to users. You optimized for developers, not users.'
      ],
      solutionApproach: [
        '👥 Involve Users Throughout: User-centered design involves users at EVERY stage. STAGE 1 - Research: Interview 20 students. "What financial problems do you have?" (Bill splitting, overspending tracking.) STAGE 2 - Ideation: Brainstorm solutions WITH users. "Would bill-splitting help?" (Yes!) "Would investment tracking help?" (No, we do not invest.) STAGE 3 - Prototyping: Show paper prototype to 10 students. Refine based on feedback. STAGE 4 - Building: Build MVP. Test with 30 students weekly. STAGE 5 - Launch: Launch. Gather feedback. Iterate. Users are involved from Week 1 to Week 52. Not just at launch. Throughout.',
        '🎯 Start with User Outcomes: Before designing features, ask: "What do users want to ACHIEVE?" Students want: (1) Know if they can afford weekend plans (outcome: financial awareness), (2) Split bills easily (outcome: avoid awkwardness, fair sharing), (3) Track overspending (outcome: stay within budget). NOW design features that deliver these outcomes: (1) Simple dashboard: "You spent ₹3000/₹5000 this month. You can afford weekend plans." (2) Bill splitter: Add expense → Auto-calculate who owes whom. (3) Overspending alert: "You spent 80% of budget. Slow down." Features serve outcomes. Outcomes serve users. User-centered.',
        '♿ Design for Accessibility: User-centered design is inclusive. Design for: (1) Visual impairments (screen reader support, high contrast mode, large fonts), (2) Motor impairments (keyboard navigation, large tap targets), (3) Cognitive differences (simple language, clear instructions, no jargon), (4) Diverse contexts (slow internet, old phones, small screens). Example: Your AI app requires high-speed internet (real-time data), latest phone (ML algorithms), financial knowledge (jargon). Only 10% of students can use it. Accessible design: Works on 2G internet, works on 3-year-old phones, uses simple language. 90% of students can use it. Accessibility = larger user base.',
        '🌍 Test with Diverse Users: Do not test with only 1 type of user (urban, English-speaking, tech-savvy B.Com students). Test with diverse users: (1) Urban + Rural students (different financial contexts), (2) English + Hindi + Regional language speakers (language accessibility), (3) Tech-savvy + Non-tech-savvy (different comfort levels), (4) High-income + Low-income families (different financial needs). Diverse testing reveals: Your app assumes high-speed internet (urban bias). Your app is English-only (language bias). Your app assumes financial literacy (education bias). Diverse testing = inclusive design = larger market.',
        '📊 Measure User Satisfaction: The ONLY metric that matters is: Are users satisfied? Did they achieve their goal? Technical metrics (AI accuracy, latency, efficiency) are means, not ends. User metrics (satisfaction, task completion, time to value, retention, NPS) are ends. Measure: (1) Satisfaction: Rate 1-10, how satisfied? (2) Task completion: Did they achieve their goal? (Split bills? Track spending?) (3) Time to value: How long to get value? (30 seconds? 30 minutes?) (4) Retention: Do they come back? (5) NPS: Would they recommend? Optimize for USER metrics, not TECH metrics. Users do not care if your AI is 95% accurate. They care if the app helps them afford weekend plans.',
        '🔄 Iterate Based on User Feedback: User-centered design is iterative. V1.0: Launch with 4 features. Measure: 6/10 satisfaction. Feedback: "Want time estimates." V1.1: Add time estimates. Measure: 7/10 satisfaction. Feedback: "Want subject grouping." V1.2: Add grouping. Repeat. Users guide your roadmap. You do not decide features in isolation (what YOU think is cool). Users decide features through feedback (what THEY find useful). User-centered = user-driven. You follow users, not your ego.'
      ]
    },
    video: {
